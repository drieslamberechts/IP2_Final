...
namespace XNA_ENGINE.Game.Helpers
{
    class StandardCost
    {
        ...
        public static int COSTOFWOOD_SOLDIER = 20;
        public static int COSTOFWOOD_SHAMAN = 0;
        ...
        public static int COSTOFINFLUENCE_SOLDIER = 0;
        public static int COSTOFINFLUENCE_SHAMAN = 50;
