...
namespace XNA_ENGINE.Game.Objects.TutorialClasses
{
    class Background
    {
        //-------------------------------------------------------------------
        ...
        //------------------------------------------------------------
            public void Draw(SpriteBatch spriteBatch)
            {
                ...
                spriteBatch.Draw(
                    t2dBackground,
                    new Rectangle(-1 * iBackgroundOffset, 0, iBackgroundWidth, iViewportHeight), Color.White);
                ...
                if (drawParallax)
                {
                    ...
                    spriteBatch.Draw(t2dParallax, new Rectangle(-1 * iParallaxOffset, 0, iParallaxWidth, iViewportHeight), Color.SlateGray);
                    ...
                    {
                        spriteBatch.Draw(t2dParallax, new Rectangle((-1 * iParallaxOffset) + iParallaxWidth, 0, iParallaxWidth, iViewportHeight), Color.SlateGray);
                    }
                }
            }
    }
